...
/*!**************************************!*\
  ...
  \**************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _popup_components_sendDayReportHelper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../popup/components/sendDayReportHelper */ "./src/popup/components/sendDayReportHelper.tsx");
...
setTimeout(function () {
    chrome.storage.local.get((res) => {
        var _a;
        if (res.username) {
            (0,_popup_components_sendDayReportHelper__WEBPACK_IMPORTED_MODULE_0__.sendDayReport)(res.username, ((_a = res.entries) === null || _a === void 0 ? void 0 : _a.length) > 0 ? res.entries : [], res.hours || 0);
        }
